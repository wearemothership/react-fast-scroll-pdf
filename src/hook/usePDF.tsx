	...
	if (container) {
		...
		// Retry after slight delay if layout still shifting
		setTimeout(() => {
			const correctedScrollHeight = container.scrollHeight;
			const retryCenterPoint = correctedScrollHeight * centerRatio;
			container.scrollTop = Math.max(0, retryCenterPoint - (container.clientHeight / 2));
		}, 200);
	}
}, 0);
